...
// Equality Test (False)
console.log("Equality Test with strings: ", ("Banana"as string)==="banana");

//Inequality Test (True)
console.log("Inequality Test with strings: ", ("Banana"as string)!="Apple");
...
console.log("Equality Test with Numbers: ", (5 as number) === 6);
...
console.log("Test using 'or' operators", (5 as number) === 6 || 5 > 10);

//Test weather an item is in a array (True)
let places:string[]=['Pakistan','India','China'];
